-- Configuración inicial para asegurar compatibilidad
...
CREATE TABLE IF NOT EXISTS `equipos_departamentos` (
...
CREATE TABLE IF NOT EXISTS `equipos_requerimientos` (
...
CREATE TABLE IF NOT EXISTS `estados_requerimiento` (
...
CREATE TABLE IF NOT EXISTS `usuarios_tic` (
  ...
  `comentario_nombrer_usuario` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
